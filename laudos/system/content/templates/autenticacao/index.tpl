...
<link rel="stylesheet" type="text/css" href="{.$path_tpl.}login.css"/>
...
<body>
	...
	<div id="geral">
		...
		<table cellpadding="0" cellspacing="0" border="0"><tr>
			...
			<td><div id="conteudo">
				<div id="barra_topo"><img id="gerencia" src="{.$path_tpl.}images/gerencia.jpg"/><div id="barra_topo_sombra"></div></div>
				
				<div id="centro">
					<img class="imagem" src="{.$path_tpl.}images/centro_imagem.jpg"/>
					...
					<div id="login">
						<form id="form" name="form" action="{.$self.}" method="post" >
							...
							<a href="javascript:send('');"><img class="entrar" src="{.$path_tpl.}images/botao_entrar.jpg"/></a>
						</form>
					</div>
				</div>
